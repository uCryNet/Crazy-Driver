...
namespace Gley.TrafficSystem
{
    public class DebugOptions
    {
        ...
        {
            return LoadOrCreateDataAsset<DebugSettings>(GetRootFolder(TrafficSystemConstants.PACKAGE_NAME, UrbanSystem.UrbanSystemConstants.PARENT), TrafficSystemConstants.DebugOptionsPath, TrafficSystemConstants.DebugOptionsName);
        }
