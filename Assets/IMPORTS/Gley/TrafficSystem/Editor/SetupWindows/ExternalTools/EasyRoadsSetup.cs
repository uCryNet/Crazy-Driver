...
namespace Gley.TrafficSystem.Editor
{
    public class EasyRoadsSetup : SetupWindowBase
    {
        ...
        protected override void TopPart()
        {
            ...
            {
                Gley.Common.Editor.PreprocessorDirective.AddToCurrent(TrafficSystemConstants.GLEY_EASYROADS_TRAFFIC, true);
            }
#else
            if (GUILayout.Button("Enable Easy Roads Support"))
            {
                Gley.Common.Editor.PreprocessorDirective.AddToCurrent(TrafficSystemConstants.GLEY_EASYROADS_TRAFFIC, false);
            }
#endif
