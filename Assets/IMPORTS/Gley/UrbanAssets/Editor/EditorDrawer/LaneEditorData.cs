...
{
    public struct LaneHolder<T> where T : WaypointSettingsBase
    {
        public string Name { get; private set; }
        public T[] Waypoints { get; private set; }
    ...
    public class LaneEditorData<T, R> : EditorData where T : RoadBase where R : WaypointSettingsBase
    {
        ...
        public LaneHolder<R>[] GetRoadLanes(T road)
        {
        ...
        {
            Transform lanesHolder = road.transform.Find(UrbanSystemConstants.LanesHolderName);
