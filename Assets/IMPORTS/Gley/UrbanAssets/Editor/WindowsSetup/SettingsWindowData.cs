...
namespace Gley.UrbanSystem.Editor
{
    ...
    {
        public List<int> Id = new List<int> { -1 };          // speed values
        public List<Color> RoutesColor = new List<Color> { Color.white }; // associated colors
        public List<bool> Active = new List<bool> { true };     // active flags
    }
