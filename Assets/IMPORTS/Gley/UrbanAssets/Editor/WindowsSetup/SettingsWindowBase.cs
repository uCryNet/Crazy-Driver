...
namespace Gley.UrbanSystem.Editor
{
    public abstract class SettingsWindowBase : EditorWindow
    {
        ...
        protected NavigationRuntimeData _backData;
        ...
        public void SetActiveWindow(Type windowType, bool addCurrent)
        {
            if (windowType == null)
            {
                return;
        ...
        private void Input()
        {
            ...
            if (_canClick)
            {
                ...
                if (e.type == EventType.Layout && GUIUtility.hotControl == UrbanSystemConstants.PATH_ID)
                {
